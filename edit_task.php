 ...
 <div class="container-page mt-5 pt-4 pb-4">
    <div class="row">
      <div class="col mr-auto ml-auto">
        ...
        <form name="addTaskForm" class="addTaskForm" action="php/edittask.php" method="post">
          ...
          <div class="container">
              ...
              <input type="text" placeholder="Tittle" name="tittle" Id="Tittle" value="<?php echo $title;?>"/>
              <div class="invalid-input">
                  An unexpected error has occured
              </div>
             
              <label for="Password"><b>Description</b></label>
              <input type="text" placeholder="Description" name="description" Id="Description"value="<?php echo $description;?>"/>
              <div class="invalid-input">
                  An unexpected error has occured
              </div>
